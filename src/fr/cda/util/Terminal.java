...
*/
    public static String[] lireFichierTexte(String nomFichier)
    {
        try{
            ...
            // On enleve le caractere '\r' code 13 qui est ajoute en Windowse
            // Les fins de ligne dans un fichier texte cre sous Windows
            //  se termine par \r\n.
    ...
    /** Cette methode permet de creer un fichier texte a partir du contenu d'un StringBuffer.
        @param nomFichier Le nom du fichier qui est cre dans le repertoire courant
    ...
    */
    ...
    /** Cette methode lit une chaîne de caractere
        @return String la chaîne saisie dans la console d'execution
