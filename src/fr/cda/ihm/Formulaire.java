...
public class Formulaire
{
    ...
    /*  Verrou de synchronisation pour être synchrone e
    ...
    */
    ...
    /** Initialise l'applicatif.<br>Cette methode est utilisee dans le cas où quand on cree le formulaire on ne connait pas encore l'applicatif qui gere le formulaire. On appelle alors cette methode pour initialiser l'applicatif du formulaire.
    ...
    */
    ...
    /** Change la position courante par delta
     @param deltax position en abscisse (horizontal) de la fenetre e
    ...
    */
    ...
    /** Affichage du formulaire.<br>
     Cette methode peut être synhrone (voir le parametre synhrone a la creation du formulaire.
    */
    ...
    */
    public static void main (String... args) throws Exception
    {
        ...
        String[] values = { "la belle de nuit", "la fille de l'air","le garçon manque","abcdefghijklmnopqrstuvwxyz","111","2222","3333"};
